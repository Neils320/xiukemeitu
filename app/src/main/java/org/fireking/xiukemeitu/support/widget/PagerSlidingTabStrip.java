...
package org.fireking.xiukemeitu.support.widget;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public WbViewPager.OnPageChangeListener delegatePageListener;
	...
	public void setViewPager(WbViewPager pager) {
		this.pager = pager;
	...
	public void setOnPageChangeListener(WbViewPager.OnPageChangeListener listener) {
	...
	private class PageListener implements WbViewPager.OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int state) {
			if (state == WbViewPager.SCROLL_STATE_IDLE) {
